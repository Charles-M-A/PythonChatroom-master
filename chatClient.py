...
connectionList = [sock, clientConnection]
        ...
        if userSocket is clientConnection:
            ...
            # else the server is working, print then wait for user to add command
                ...
                if msg == QUITCOMMAND.encode():
                    ...
                    if 'Enter your screen name:' in msg.decode() or 'Wrong password!!!' in msg.decode():
                        # add messge
                        print("(Type password after username separated by a blank space)")
                        msgPrefix = 'name: '
